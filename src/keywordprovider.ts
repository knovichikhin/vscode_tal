...
class Keyword {
    ...
    label: string;
    // CompletionItem insertText, will be used as a snippet
    snippet: string;
    ...
    constructor(label: string, snippet: string, detail: string, documentation: string, kind: vscode.CompletionItemKind) {
        this.label = label;
...
keywords.push(
    new Keyword(
        '$dbll',
        '\\$dbll(${1:int_expression}, ${2:int_expression})$0',
...
keywords.push(
    new Keyword(
        '$dfix',
        '\\$dfix(${1:dbl_expression}, ${2:fpoint})$0',
...
keywords.push(
    new Keyword(
        '$ifix',
        '\\$ifix(${1:int_expression}, ${2:fpoint})$0',
...
keywords.push(
    new Keyword(
        '$lfix',
        '\\$lfix(${1:int_expression}, ${2:fpoint})$0',
...
keywords.push(
    new Keyword(
        '$lmax',
        '\\$lmax(${1:int_expression}, ${2:int_expression})$0',
...
keywords.push(
    new Keyword(
        '$lmin',
        '\\$lmin(${1:int_expression}, ${2:int_expression})$0',
...
keywords.push(
    new Keyword(
        '$max',
        '\\$max(${1:expression}, ${2:expression})$0',
...
keywords.push(
    new Keyword(
        '$min',
        '\\$min(${1:expression}, ${2:expression})$0',
...
keywords.push(
    new Keyword(
        '$optional',
        '\\$optional(${1:cond_expression}, ${2:param})$0',
...
export class TALCompletionItemProvider implements vscode.CompletionItemProvider {
    public provideCompletionItems(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken, context: vscode.CompletionContext): vscode.ProviderResult<vscode.CompletionItem[] | vscode.CompletionList> {
        ...
        keywords.forEach(k => {
            ...
            completionItem.insertText = new vscode.SnippetString(k.snippet);
