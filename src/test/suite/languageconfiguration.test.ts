...
suite("TAL Language Configuration: onEnterRules", () => {
  ...
  [
    ...
    [
      ...
      test(`Check that indent-on-enter applies to "${
        testString + commentString
      }"`, () => {
  ...
  [
    ...
    [
      ...
      test(`Check that indent-on-enter does not apply to "${
        testString + commentString
      }"`, () => {
        const result = INDENT_ONENTER_REGEX.test(testString + commentString);
  ...
  [
    ...
    [
      ...
      test(`Check that outdent-on-enter applies to "${
        testString + commentString
      }"`, () => {
  ...
  [
    ...
    [
      ...
      test(`Check that outdent-on-enter does not apply to "${
        testString + commentString
      }"`, () => {
        const result = OUTDENT_ONENTER_REGEX.test(testString + commentString);
        assert.strictEqual(result, false);
